...
class TsscTopicTest {
	...
	void encontrarTopicPorElDateGameTest() {
		...
		ArrayList<TsscGame> listaJuegos3 = new ArrayList<TsscGame>();
		...
		temaNumero3.setTsscGames(listaJuegos3);
	
		
		
		TsscGame juegoNumero6 = new TsscGame();
		juegoNumero6.setNGroups(14);
		juegoNumero6.setNSprints(874);
		juegoNumero6.setName("Juego Numero 5");
		juegoNumero6.setAdminPassword("65465sd54sa");
		juegoNumero6.setGuestPassword("5445s54dsa");
		juegoNumero6.setScheduledDate(LocalDate.of(2020, 4, 4));
		juegoNumero6.setScheduledTime(LocalTime.of(16, 34));
		juegoNumero6.setUserPassword("5445sdasd");
		juegoNumero6.setTsscTopic(temaNumero3);
		
		gameServiceImp.guardar(juegoNumero6);
		temaNumero3.getTsscGames().add(juegoNumero6);
		TopicServiceImp.guardar(temaNumero3);
		
		TsscTopic temaNumero4 = new TsscTopic();
		temaNumero4.setName("Tema Numero 4");
		temaNumero4.setDescription("Descripcion tema numero 4");
		temaNumero4.setGroupPrefix("Mig");
		temaNumero4.setDefaultGroups(10);
		temaNumero4.setDefaultSprints(9);

		TopicServiceImp.guardar(temaNumero4);
;

		List<Object[]> resultado = TopicServiceImp.encontrarTopicPorElDateGame(LocalDate.of(2020, 4, 4));

		assertTrue(TopicServiceImp.encontrarTopicPorElDateGame(LocalDate.of(2020, 4, 4)).size() == 3);
		assertEquals(((TsscTopic) (TopicServiceImp.encontrarTopicPorElDateGame(LocalDate.of(2020, 4, 4)).get(0)[0])).getName(), temaNumero1.getName());
		assertTrue(((Long)(TopicServiceImp.encontrarTopicPorElDateGame(LocalDate.of(2020, 4, 4)).get(0)[1])) == 2);
		assertEquals(((TsscTopic) (TopicServiceImp.encontrarTopicPorElDateGame(LocalDate.of(2020, 4, 4)).get(1)[0])).getName(), temaNumero2.getName());
		assertTrue(((Long)(TopicServiceImp.encontrarTopicPorElDateGame(LocalDate.of(2020, 4, 4)).get(1)[1])) == 2);
		assertEquals(((TsscTopic) (TopicServiceImp.encontrarTopicPorElDateGame(LocalDate.of(2020, 4, 4)).get(2)[0])).getName(), temaNumero3.getName());
		assertTrue(((Long)(TopicServiceImp.encontrarTopicPorElDateGame(LocalDate.of(2020, 4, 4)).get(2)[1])) == 1);
