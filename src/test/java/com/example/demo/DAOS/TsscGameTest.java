...
class TsscGameTest {
	...
	void encontrarPorDateHoursTest() {
		...
		assertTrue(gameServiceImp.encontrarPorDateHours(gameOne.getScheduledDate(),gameOne.getScheduledTime(), gameTwo.getScheduledTime()).contains(gameTwo));
